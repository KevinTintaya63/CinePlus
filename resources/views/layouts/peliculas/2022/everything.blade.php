    ...
    <style>
        ...
        * {
        ...
        .pelicula-principal {
            ...
            min-height: 40.62em;
            color: #fff;
            background: linear-gradient(rgba(214, 95, 15, 0.5)0%, rgba(0, 0, 0, .50) 100%), url('https://q9c3t4p4.rocketcdn.me/wp-content/uploads/2023/03/Everything-Everywhere-All-At-Once-Cast-Showtime-Every-Actor-Character.jpeg');
    ...
    <section id="top">
        <main>
            <div class="pelicula-principal">
                <div class="contenedor">
                    <h3 class="titulo">Everything Everywhere all at Once</h3>
                    <p class="descripcion">
                    Cuando una ruptura interdimensional altera la realidad, Evelyn (Michelle Yeoh), una inmigrante china en Estados Unidos, 
                    se ve envuelta en una aventura salvaje en la que solo ella puede salvar el mundo. Perdida en los mundos infinitos del multiverso, 
                    esta heroína inesperada debe canalizar sus nuevos poderes para luchar contra los extraños y desconcertantes peligros del multiverso 
                    mientras el destino del mundo pende de un hilo.
                    </p>
                    <a href="https://www.youtube.com/watch?v=wxN1T1uxQ2g" alt="Mythrill" target="_blank"><button
                    ...
                    <a href="https://www.imdb.com/title/tt6710474/" alt="Mythrill" target="_blank"><button
