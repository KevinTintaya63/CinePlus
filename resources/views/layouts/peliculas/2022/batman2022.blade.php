    ...
    <style>
        ...
        * {
        ...
        .pelicula-principal {
            ...
            min-height: 40.62em;
            color: #fff;
            background: linear-gradient(rgba(214, 95, 15, 0.5)0%, rgba(0, 0, 0, .50) 100%), url('https://fictionhorizon.com/wp-content/uploads/2022/02/B61F41AD-6007-4197-8A34-3D456E8AD4CC-1024x538.jpeg');
    ...
    <section id="top">
        <main>
            <div class="pelicula-principal">
                <div class="contenedor">
                    <h3 class="titulo">Batman 2022</h3>
                    <p class="descripcion">
                    Después de dos años acechando por las calles de la ciudad como Batman (Robert Pattinson), e infundiendo miedo en las 
                    mentes perversas de los criminales, Bruce Wayne está sumido en las profundidades de las sombras de Gotham City. 
                    Este vigilante solitario cuenta con pocos aliados de confianza y eso le ha llevado a convertirse en la única encarnación 
                    de la venganza entre sus conciudadanos. Cuando un asesino apunta a la élite de Gotham con una serie de maquinaciones sádicas,
                     un rastro de pistas crípticas lleva a Batman a realizar una investigación en el inframundo.
                    </p>
                    <a href="https://www.youtube.com/watch?v=fWQrd6cwJ0A" alt="Mythrill" target="_blank"><button
                    ...
                    <a href="https://www.imdb.com/title/tt1877830/" alt="Mythrill" target="_blank"><button
