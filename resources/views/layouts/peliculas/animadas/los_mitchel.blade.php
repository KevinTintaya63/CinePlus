    ...
    <style>
        ...
        * {
        ...
        .pelicula-principal {
            ...
            min-height: 40.62em;
            color: #fff;
            background: linear-gradient(rgba(243, 166, 33 ) 0%, rgba(0, 0, 0, .50) 40%), url('https://occ.a.nflxso.net/dnm/api/v6/6gmvu2hxdfnQ55LZZjyzYR4kzGk/AAAABYDsbYSRVbTLiSARgOtY61zUEFrVC7z2EAg4S3GbsPuruhVo7jzQbYJGxIJJ10Y2P_OvIELbh-yBptqDpq0JPjxWEpkiJQ0Mwahmesfh_5akCsACweEeRF8Sv9UtRtuAxiQdmQ.jpg?r=f41');
    ...
    <section id="top">
        <main>
            <div class="pelicula-principal">
                <div class="contenedor">
                    <h3 class="titulo">Los Mitchell</h3>
                    <p class="descripcion">
                    Ambientada a finales de septiembre de 2020, la historia sigue a Katie Mitchell, una peculiar 
                    ...
                    <a href="https://www.youtube.com/watch?v=cMLcCLglGoQ" alt="Mythrill" target="_blank"><button
                    ...
                    <a href="https://www.imdb.com/title/tt7979580/" alt="Mythrill" target="_blank"><button
