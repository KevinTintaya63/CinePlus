    ...
    <style>
        ...
        * {
        ...
        .pelicula-principal {
            ...
            min-height: 40.62em;
            color: #fff;
            background: linear-gradient(rgba(249, 80, 35) 0%, rgba(0, 0, 0, .50) 40%), url('https://cdn.atomix.vg/wp-content/uploads/2021/07/red-.jpg');
    ...
    <section id="top">
        <main>
            <div class="pelicula-principal">
                <div class="contenedor">
                    <h3 class="titulo">Turning Red</h3>
                    <p class="descripcion">
                    A mediados de marzo del año 2002, Meilin "Mei" Lee es una niña canadiense de ascendencia china de 13 años que vive en la ciudad de Toronto. 
                    ...
                    <a href="https://www.youtube.com/watch?v=upGoAejd7LM" alt="Mythrill" target="_blank"><button
                    ...
                    <a href="https://www.imdb.com/title/tt8097030/?ref_=nv_sr_srsg_0_tt_8_nm_0_q_turning" alt="Mythrill" target="_blank"><button
