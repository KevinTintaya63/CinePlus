    ...
    <style>
        ...
        * {
        ...
        .pelicula-principal {
            ...
            min-height: 40.62em;
            color: #fff;
            background: linear-gradient(rgba(17, 162, 30) 0%, rgba(0, 0, 0, .50) 40%), url('https://wallpapers.com/images/hd/shrek-2-poster-main-cast-1n0p7vu78dwbr3m0.jpg');
    ...
    <section id="top">
        <main>
            <div class="pelicula-principal">
                <div class="contenedor">
                    <h3 class="titulo">Sherk 2</h3>
                    <p class="descripcion">
                    Algunos meses después de que el ogro Shrek y la princesa Fiona se conocieran y se casaran, el Príncipe Encantador va en 
                    ...
                    <a href="https://www.youtube.com/watch?v=xGU-JTRdBRI" alt="Mythrill" target="_blank"><button
                    ...
                    <a href="https://www.imdb.com/title/tt0298148/?ref_=nv_sr_srsg_3_tt_5_nm_3_q_shre" alt="Mythrill" target="_blank"><button
