    ...
    <style>
        ...
        * {
        ...
        .pelicula-principal {
            ...
            min-height: 40.62em;
            color: #fff;
            background: linear-gradient(rgba(5, 25, 62 ) 0%, rgba(0, 0, 0, .50) 40%), url('https://lumiere-a.akamaihd.net/v1/images/richbanner-toystory4_0026da28.jpeg?region=0,0,1920,1045');
    ...
    <section id="top">
        <main>
            <div class="pelicula-principal">
                <div class="contenedor">
                    <h3 class="titulo">Toy Story 4</h3>
                    <p class="descripcion">
                    Hace nueve años, tiempo antes de los eventos de Toy Story 3, Bo Peep y Woody tratan de rescatar a Control, el carro a control remoto de Andy, 
                    ...
                    <a href="https://www.youtube.com/watch?v=f33yJZ5uOpU" alt="Mythrill" target="_blank"><button
                    ...
                    <a href="https://www.imdb.com/title/tt1979376/?ref_=nv_sr_srsg_3_tt_8_nm_0_q_toy%2520stoyry" alt="Mythrill" target="_blank"><button
