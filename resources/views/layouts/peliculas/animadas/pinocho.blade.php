...
<head>
    ...
    <title>Pinocho de Guillermo del Toro</title>
    ...
    <style>
        ...
        * {
        ...
        .pelicula-principal {
            ...
            min-height: 40.62em;
            color: #fff;
            background: linear-gradient(rgb(150, 100, 66) 0%, rgba(0, 0, 0, .50) 40%), url('https://thecollision.org/wp-content/uploads/2022/12/2.png');
    ...
    <section id="top">
        <main>
            <div class="pelicula-principal">
                <div class="contenedor">
                    <h3 class="titulo">Pinocho de Guillermo del Toro</h3>
                    <p class="descripcion">
                    ...
                    <a href="https://www.youtube.com/watch?v=-WgZ_IQU0Ks" alt="Mythrill" target="_blank"><button
                    ...
                    <a href="https://www.imdb.com/title/tt1488589/?ref_=nv_sr_srsg_0_tt_8_nm_0_q_pinoc" alt="Mythrill" target="_blank"><button
