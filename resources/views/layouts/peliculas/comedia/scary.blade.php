    ...
    <style>
        ...
        * {
        ...
        .pelicula-principal {
            ...
            min-height: 40.62em;
            color: #fff;
            background: linear-gradient(rgba(153, 55, 55, 0.5)0%, rgba(0, 0, 0, .50) 40%), url('https://cdn.discordapp.com/attachments/864577245905551391/1098471856522137621/MjAwMC5qcGc.png');
    ...
    <section id="top">
        <main>
            <div class="pelicula-principal">
                <div class="contenedor">
                    <h3 class="titulo">Scary Movie</h3>
                    <p class="descripcion">
                    Una bella estudiante muere asesinada. Un grupo de desorientados adolescentes descubre que entre ellos 
                    hay un asesino. La heroína Cyndi Campbell y su grupo de despistados amigos se verán aterrorizados por
                    un singular psicópata enmascarado que pretende vengarse de ellos, después de que lo atropellaran por 
                    accidente el pasado Halloween.
                    </p>
                    <a href="https://www.youtube.com/watch?v=HTLPULt0eJ4" alt="Mythrill" target="_blank"><button
                    ...
                    <a href="https://www.imdb.com/title/tt0175142/?ref_=nv_sr_srsg_1_tt_7_nm_0_q_scary" alt="Mythrill" target="_blank"><button
