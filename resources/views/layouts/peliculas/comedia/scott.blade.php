    ...
    <style>
        ...
        * {
        ...
        .pelicula-principal {
            ...
            min-height: 40.62em;
            color: #fff;
            background: linear-gradient(rgba(214, 15, 15, 0.5)0%, rgba(0, 0, 0, .50) 40%), url('https://rare-gallery.com/uploads/posts/1173206-illustration-red-movies-Scott-Pilgrim-vs-the-World-poster-brand-bass-guitars-Michael-Cera-advertising-computer-wallpaper-album-cover.jpg');
    ...
    <section id="top">
        <main>
            <div class="pelicula-principal">
                <div class="contenedor">
                    <h3 class="titulo">Scott Pilgrim</h3>
                    <p class="descripcion">
                    Scott Pilgrim (Michael Cera) es un joven que conoce a la mujer de sus sueños, Ramona V. Flowers (Mary Elizabeth Winstead).
                    Pero para conquistar su corazón, deberá primero luchar y vencer a sus siete malvadas exparejas, misión harto complicada,
                    pues tienen poderes especiales... 
                    </p>
                    <a href="https://www.youtube.com/watch?v=7wd5KEaOtm4" alt="Mythrill" target="_blank"><button
                    ...
                    <a href="https://www.imdb.com/title/tt0446029/?ref_=nv_sr_srsg_3_tt_1_nm_7_q_scott" alt="Mythrill" target="_blank"><button
