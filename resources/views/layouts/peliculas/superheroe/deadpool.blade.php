    ...
    <style>
        ...
        * {
        ...
        .pelicula-principal {
            ...
            min-height: 40.62em;
            color: #fff;
            background: linear-gradient(rgb(157, 2, 2) 0%, rgba(0, 0, 0, .50) 30%), url('https://i.ytimg.com/vi/6IDkzHEmEtg/maxresdefault.jpg');
    ...
    <section id="top">
        <main>
            <div class="pelicula-principal">
                <div class="contenedor">
                    <h3 class="titulo">Deadpool</h3>
                    <p class="descripcion">
                    Basado en el anti-héroe menos convencional de la Marvel, Deadpool narra el origen de un ex-operativo de 
                    las fuerzas especiales llamado Wade Wilson, reconvertido a mercenario, y que tras ser sometido a un cruel 
                    experimento adquiere poderes de curación rápida, adoptando Wade entonces el alter ego de Deadpool. Armado
                    con sus nuevas habilidades y un oscuro y retorcido sentido del humor, Deadpool intentará dar caza al hombre
                    que casi destruye su vida.
                    </p>
                    <a href="https://www.youtube.com/watch?v=0JnRdfiUMa8" alt="Mythrill" target="_blank"><button
                    ...
                    <a href="https://www.imdb.com/title/tt1431045/?ref_=nv_sr_srsg_3_tt_8_nm_0_q_deadp" alt="Mythrill" target="_blank"><button
