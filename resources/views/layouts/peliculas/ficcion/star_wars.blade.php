    ...
    <style>
        ...
        * {
        ...
        .pelicula-principal {
            ...
            min-height: 40.62em;
            color: #fff;
            background: linear-gradient(rgba(1, 1, 2) 0%, rgba(0, 0, 0, .50) 40%), url('https://i.blogs.es/1da08b/1366_2000-9-/1366_2000.jpeg');
        ...
        <main>
            <div class="pelicula-principal">
                <div class="contenedor">
                    ...
                    <p class="descripcion">
                    La trama descrita en las nueve películas que componen la serie principal de Star Wars relata las vivencias de la familia 
                    Skywalker,17​ «hace mucho tiempo en una galaxia muy muy lejana»,18​ cuyos integrantes son capaces de percibir y utilizar 
                    «La Fuerza», lo cual les permite desarrollar habilidades como la telequinesis, la clarividencia y el control mental, 
                    entre otras.
                    </p>
                    <a href="https://www.youtube.com/watch?v=xr3hPFJAHO4" alt="Mythrill" target="_blank"><button
                    ...
                    <a href="https://www.imdb.com/title/tt0080684/" alt="Mythrill" target="_blank"><button
