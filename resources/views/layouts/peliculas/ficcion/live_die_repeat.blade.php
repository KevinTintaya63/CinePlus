    ...
    <style>
        ...
        * {
        ...
        .pelicula-principal {
            ...
            min-height: 40.62em;
            color: #fff;
            background: linear-gradient(rgb(207, 196, 134)0%, rgba(0, 0, 0, .50) 40%), url('https://www.slashfilm.com/img/gallery/why-edge-of-tomorrow-got-retitled-live-die-repeat/intro-import.jpg');
    ...
    <section id="top">
        <main>
            <div class="pelicula-principal">
                <div class="contenedor">
                    <h3 class="titulo">Live Die Repeat</h3>
                    <p class="descripcion">
                    El enemigo sabrá que venimos y nos matarán a todos. Cuando llegan a París hay la clásica escena
                    de película de terror en la que uno de ellos se separa del grupo, y es atacado por un Alfa y lo mata.
                    Cuando lo mata, se ve que el Omega vuelve a empezar y se ve el punto de vista del villano.
                    </p>
                    <a href="https://youtu.be/eb8wTIcGLgQ" alt="Mythrill" target="_blank"><button
                    ...
                    <a href="https://www.imdb.com/title/tt5617712/?ref_=ext_shr_lnk" alt="Mythrill" target="_blank"><button
