    ...
    <style>
        ...
        * {
        ...
        .pelicula-principal {
            ...
            min-height: 40.62em;
            color: #fff;
            background: linear-gradient(rgba(87, 14, 222, 0.5) 0%, rgba(0, 0, 0, .50) 40%), url('https://mir-s3-cdn-cf.behance.net/project_modules/fs/f8b2ef92655071.5e505bf7132ab.png');
    ...
    <section id="top">
        <main>
            <div class="pelicula-principal">
                <div class="contenedor">
                    <h3 class="titulo">La la Land</h3>
                    <p class="descripcion">
                    La película cuenta la historia de Mia, una empleada de un bar que aspira a ser actriz y Sebastián,
                    un pianista de jazz desempleado con grandes ambiciones. ​ A pesar de sus diferencias y sus distintas
                    personalidades, gracias a una serie de acontecimientos harán que sus caminos acaben cruzándose.
                    </p>
                    <a href="https://youtu.be/0pdqf4P9MB8" alt="Mythrill" target="_blank"><button
                    ...
                    <a href="https://www.imdb.com/title/tt1288499/?ref_=ext_shr_lnk" alt="Mythrill" target="_blank"><button
