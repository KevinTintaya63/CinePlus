    ...
    <style>
        ...
        * {
        ...
        .pelicula-principal {
            ...
            min-height: 40.62em;
            color: #fff;
            background: linear-gradient(rgba(219, 216, 19, 0.5) 0%, rgba(0, 0, 0, .50) 40%), url('https://i.etsystatic.com/27817007/r/il/2d5a06/2875419068/il_fullxfull.2875419068_iiiz.jpg');
    ...
    <section id="top">
        <main>
            <div class="pelicula-principal">
                <div class="contenedor">
                    <h3 class="titulo">Singing in the rain</h3>
                    <p class="descripcion">
                    La película habla de la historia de Don Lockwood (Genne Kelly) un joven ídolo del cine mudo que cree
                    que lo tiene todo en la vida: fama, fortuna y éxito, cuando conoce a la joven aspirante a actriz
                    Kathy Selden (Debbie Reynolds). Entonces el actor se da cuenta de que ella es realmente lo que
                    le falta en su vida.
                    </p>
                    <a href="https://youtu.be/5_EVHeNEIJY" alt="Mythrill" target="_blank"><button
                    ...
                    <a href="https://www.imdb.com/title/tt0045152/?ref_=ext_shr_lnk" alt="Mythrill" target="_blank"><button
