    ...
    <style>
        ...
        * {
        ...
        .pelicula-principal {
            ...
            min-height: 40.62em;
            color: #fff;
            background: linear-gradient(rgba(128, 14, 222, 0.5) 0%, rgba(0, 0, 0, .50) 40%), url('https://vupulse-api-production.s3.amazonaws.com/media/programs/destination-images/1d4ab812-4d45-449d-b42c-f8105a4d82eb.jpg');
    ...
    <section id="top">
        <main>
            <div class="pelicula-principal">
                <div class="contenedor">
                    <h3 class="titulo">Rocketman</h3>
                    <p class="descripcion">
                    Rocketman narra la historia personal de los años que hicieron famoso a Elton John.
                    La película sigue la metamorfosis que transformó al tímido prodigio del piano Reginald Dwight
                    en la superestrella internacional Elton John.
                    </p>
                    <a href="https://youtu.be/S3vO8E2e6G0" alt="Mythrill" target="_blank"><button
                    ...
                    <a href="https://www.imdb.com/title/tt2066051/?ref_=ext_shr_lnk" alt="Mythrill" target="_blank"><button
