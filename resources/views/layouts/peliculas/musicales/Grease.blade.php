    ...
    <style>
        ...
        * {
        ...
        .pelicula-principal {
            ...
            min-height: 40.62em;
            color: #fff;
            background: linear-gradient(rgba(48, 120, 202, 0.5) 0%, rgba(0, 0, 0, .50) 40%), url('https://w0.peakpx.com/wallpaper/497/771/HD-wallpaper-movie-grease-john-travolta-olivia-newton-john.jpg');
    ...
    <section id="top">
        <main>
            <div class="pelicula-principal">
                <div class="contenedor">
                    <h3 class="titulo">Grease</h3>
                    <p class="descripcion">
                    Grease (conocida como Grease en Argentina, España, Perú y Uruguay; Grease brillantina en Chile
                    y Colombia; y Vaselina en el resto de Hispanoamérica) es una película musical ambientada en
                    los años cincuenta en Estados Unidos cruzándose.
                    </p>
                    <a href="https://youtu.be/qDKo8DNpwOw" alt="Mythrill" target="_blank"><button
                    ...
                    <a href="https://www.imdb.com/title/tt0077631/?ref_=ext_shr_lnk" alt="Mythrill" target="_blank"><button
