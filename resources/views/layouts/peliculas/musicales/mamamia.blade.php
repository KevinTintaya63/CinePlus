    ...
    <style>
        ...
        * {
        ...
        .pelicula-principal {
            ...
            min-height: 40.62em;
            color: #fff;
            background: linear-gradient(rgba(20, 136, 182, 0.5) 0%, rgba(0, 0, 0, .50) 40%), url('https://justalrightreviewsdotcom.files.wordpress.com/2018/07/mamma-mia-here-we-go-again.png?w=1200');
    ...
    <section id="top">
        <main>
            <div class="pelicula-principal">
                <div class="contenedor">
                    <h3 class="titulo">Mammamia</h3>
                    <p class="descripcion">
                    Donna, una madre independiente y soltera, dueña de un pequeño hotel en una idílica isla griega,
                    está a punto de dejar que se marche Sophie, la hija a la que ha criado sola. Donna ha invitado 
                    a sus dos mejores amigas a la boda de su hija: Rosie, una mujer práctica y lógica; y Tanya, rica
                    y multidivorciada.
                    </p>
                    <a href="https://youtu.be/hcgSejNB9Bk" alt="Mythrill" target="_blank"><button
                    ...
                    <a href="https://www.imdb.com/title/tt0157962/?ref_=ext_shr_lnk" alt="Mythrill" target="_blank"><button
