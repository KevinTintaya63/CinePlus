    ...
    <style>
        ...
        * {
        ...
        .pelicula-principal {
            ...
            min-height: 40.62em;
            color: #fff;
            background: linear-gradient(rgb(22, 22, 211) 0%, rgba(0, 0, 0, .50) 40%), url('https://www.terrifier2themovie.com/images/share.jpg');
    ...
    <section id="top">
        <main>
            <div class="pelicula-principal">
                <div class="contenedor">
                    <h3 class="titulo">Terrifier</h3>
                    <p class="descripcion">
                        Terrifier es una película estadounidense de terror escrita, coproducida y dirigida por Damien
                        Leone. Está basada en el cortometraje homónimo de Leone que fue incluido en su antología La
                        víspera de Halloween. Fue estrenada en el Festival de Cine de terror Telluride 2016, siendo
                        elegida posteriormente por Dread Central Presents y Epic Pictures para distribuirla en los cines
                        durante el siguiente año.
                    </p>
                    <a href="https://www.youtube.com/watch?v=UOrNESb8T4I" alt="Mythrill" target="_blank"><button
                    ...
                    <a href="https://www.imdb.com/title/tt10403420/?ref_=nv_sr_srsg_0_tt_2_nm_6_q_terr" alt="Mythrill" target="_blank"><button
