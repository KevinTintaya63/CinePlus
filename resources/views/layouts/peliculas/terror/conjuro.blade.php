    ...
    <style>
        ...
        * {
        ...
        .pelicula-principal {
            ...
            min-height: 40.62em;
            color: #fff;
            background: linear-gradient(rgb(145, 144, 144) 0%, rgba(0, 0, 0, .50) 40%), url('https://m.media-amazon.com/images/I/513ZUTaEgiL._AC_UF894,1000_QL80_.jpg');
    ...
    <section id="top">
        <main>
            <div class="pelicula-principal">
                <div class="contenedor">
                    <h3 class="titulo">El Conjuro</h3>
                    <p class="descripcion">
                        Basada en hechos reales. Narra los encuentros sobrenaturales que vivió la familia Perron en su
                        casa de Rhode Island a principios de los 70. Ed y Lorraine Warren, investigadores de renombre en
                        el mundo de los fenómenos paranormales, acuden a la llamada de una familia aterrorizada por la
                        presencia en su granja de un ser maligno.
                        <a href="https://www.youtube.com/watch?v=oUyHULb7xDI" alt="Mythrill" target="_blank"><button
                        ...
                        <a href="https://www.imdb.com/title/tt1457767/?ref_=nv_sr_srsg_0_tt_8_nm_0_q_el%2520conjuro" alt="Mythrill" target="_blank"><button
