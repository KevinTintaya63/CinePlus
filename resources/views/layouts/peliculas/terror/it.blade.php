    ...
    <style>
        ...
        * {
        ...
        .pelicula-principal {
            ...
            min-height: 40.62em;
            color: #fff;
            background: linear-gradient(rgb(214, 7, 7) 0%, rgba(0, 0, 0, .50) 40%), url('https://cdn.traileraddict.com/content/warner-bros-pictures/it-2017-poster-2.jpg');
    ...
    <section id="top">
        <main>
            <div class="pelicula-principal">
                <div class="contenedor">
                    <h3 class="titulo">IT</h3>
                    <p class="descripcion">
                        La película cuenta la historia de siete niños marginados del municipio de Derry, Maine (EE.
                        UU.), que se llaman a sí mismos "El Club de los Perdedores". Todos se han visto marginados por
                        uno u otro motivo; todos cargan con alguna de las "cualidades" favoritas de los abusones de la
                        ciudad... y todos han visto sus peores pesadillas hacerse realidad en forma de un antiguo
                        depredador que cambia de forma y al que solo logran llamar "eso".
                    </p>
                    <a href="https://www.youtube.com/watch?v=_oBZ_zTz0Nw" alt="Mythrill" target="_blank"><button
                    ...
                    <a href="https://www.imdb.com/title/tt1396484/" alt="Mythrill" target="_blank"><button
