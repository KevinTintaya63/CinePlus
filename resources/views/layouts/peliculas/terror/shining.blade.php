    ...
    <style>
        ...
        * {
        ...
        .pelicula-principal {
            ...
            min-height: 40.62em;
            color: #fff;
            background: linear-gradient(rgb(255, 234, 9) 0%, rgba(0, 0, 0, .50) 40%), url('https://dkanut5j171nq.cloudfront.net/0021/4034/The_Shining_QUAD_2017.jpg');
    ...
    <section id="top">
        <main>
            <div class="pelicula-principal">
                <div class="contenedor">
                    <h3 class="titulo">Shining</h3>
                    <p class="descripcion">
                        Jack Torrance se convierte en cuidador de invierno en el Hotel Overlook, en Colorado, con la
                        esperanza de vencer su bloqueo con la escritura. Se instala allí junto con su esposa, Wendy, y
                        su hijo, Danny, que está plagado de premoniciones psíquicas. Mientras la escritura de Jack no
                        fluye y las visiones de Danny se vuelven más preocupantes, Jack descubre oscuros secretos del
                        hotel y comienza a convertirse en un maníaco homicida, empeñado en aterrorizar a su familia.
                    </p>
                    <a href="https://www.youtube.com/watch?v=5Cb3ik6zP2I" alt="Mythrill" target="_blank"><button
                    ...
                    <a href="https://www.imdb.com/title/tt0081505/" alt="Mythrill" target="_blank"><button
