    ...
    <style>
        ...
        * {
        ...
        .pelicula-principal {
            ...
            min-height: 40.62em;
            color: #fff;
            background: linear-gradient(rgb(68, 67, 67) 0%, rgba(0, 0, 0, .50) 40%), url('https://imgs.search.brave.com/rK5Bqkf82RapibP-iYiClOcQ2U1CoGbt33tNVL_fg_Y/rs:fit:1200:720:1/g:ce/aHR0cHM6Ly93d3cu/cGVsaXNwbGF5LmNv/L3N0b3JhZ2UvaW1h/Z2VuZXMvZXh0cmFz/L3prejJrZ0dBcXd3/aXFMbnBmaFRORWpB/alBhMS5qcGc');
    ...
    <section id="top">
        <main>
            <div class="pelicula-principal">
                <div class="contenedor">
                    <h3 class="titulo">Child Play</h3>
                    <p class="descripcion">
                        Después de mudarse a una ciudad nueva, Karen le regala a su hijo Andy un muñeco que se convierte
                        en el mejor amigo del niño. Lo que ellos desconocían es que el muñeco es un ser maligno que
                        tiene vida propia. Andy deberá aliarse con otros niños vecinos para detener a esta diabólica
                        criatura que está provocando muertes en la ciudad.
                    </p>
                    <a href="https://www.youtube.com/watch?v=qDbMsaJjp3c" alt="Mythrill" target="_blank"><button
                    ...
                    <a href="https://www.imdb.com/title/tt0094862/?ref_=nv_sr_srsg_0_tt_7_nm_1_q_child%2520play" alt="Mythrill" target="_blank"><button
